...
class WP_Widget_SmartAdapt_Social_Icons_smartadapt extends WP_Widget {
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'rss' ); ?>"><?php _e( 'RSS:', 'smartadapt' ); ?>
			<input class="widefat" id="<?php echo $this->get_field_id( 'rss' ); ?>" name="<?php echo $this->get_field_name( 'rss' ); ?>" type="text" value="<?php echo $form_values['rss']; ?>" /></label>
	</p>
